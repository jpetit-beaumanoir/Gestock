...
object GestockHttpClient {
    ...
    private const val TLS_HOSTNAME = "tresf.net"
    private const val GESTOCK_PUBLIC_IP = "80.58.141.75"

    private val prefs = GestockApp.instance.getSharedPreferences("app_prefs", MODE_PRIVATE)
    private val apiKeyGuardada: String = prefs.getString("api_key_gestock", "4gWk87JnO1Bok61c3OrOSh8IVQGbkoWOpEyEcnTfyOjC1Gd24vjhbgiwKzBvo8Tc").toString()
    ...
    fun create(context: Context): OkHttpClient {
        ...
        val gestockDns = object : Dns {
            ...
            override fun lookup(hostname: String): List<InetAddress> {
                ...
                return if (hostname.equals(TLS_HOSTNAME, ignoreCase = true)) {
                    ...
                    Log.d(
                        "GestockDNS",
                        "$TLS_HOSTNAME resuelto manualmente como ${address.hostAddress}"
                    )
