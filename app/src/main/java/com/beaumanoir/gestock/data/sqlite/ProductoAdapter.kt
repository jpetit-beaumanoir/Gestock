...
import com.beaumanoir.gestock.data.AlmacenVirtualProducto

class ProductoAdapter(
    private val almacenVirtualList: List<AlmacenVirtualProducto>,
    private val listener: OnItemClickListener
) : RecyclerView.Adapter<ProductoAdapter.ProductoViewHolder>() {

    interface OnItemClickListener {
        fun onItemClick(almacenVirtual: AlmacenVirtualProducto)
    }
