...
import com.beaumanoir.gestock.data.AlmacenVirtualEliminarProducto

class EliminarProductoAdapter(
    private val items: List<AlmacenVirtualEliminarProducto>,
    private val listener: OnItemClickListener
) : RecyclerView.Adapter<EliminarProductoAdapter.MyViewHolder>() {

    interface OnItemClickListener {
        fun onItemClick(almacenVirtualEliminar: AlmacenVirtualEliminarProducto)
    }
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(almacenVirtualEliminarProducto: AlmacenVirtualEliminarProducto) {
            ...
            stockBeepeado.text = almacenVirtualEliminarProducto.cantidadEscaneada.toString()
