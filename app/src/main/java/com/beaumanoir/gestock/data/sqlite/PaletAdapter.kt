...
import com.beaumanoir.gestock.data.AlmacenVirtualPalets

class PaletAdapter(
    private val almacenVirtualList: List<AlmacenVirtualPalets>,
    private val listener: OnItemClickListener
) : RecyclerView.Adapter<PaletAdapter.PaletViewHolder>() {

    interface OnItemClickListener {
        fun onItemClick(almacenVirtual: AlmacenVirtualPalets)
    }
